    ...
    <div className="uv-facts">
      <section className="fact-section" aria-labelledby="skin-title" id="skin">
        ...
        <div className="fact-content">
          ...
          <Evidence>
            <Finding agency="DermNet" href="https://dermnetnz.org/topics/skin-phototype">{t("Photo examples use the sources’ own phototype labels. Phototype describes burning and tanning response, not an exact colour range. Lighting, body area and skin conditions affect appearance; matching a photo cannot establish an individual sunburn threshold.")}</Finding>
